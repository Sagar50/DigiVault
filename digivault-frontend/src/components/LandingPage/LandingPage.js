    ...
    return (
        <div className="landing-page">
            <div className="div2">
                <div className="div3">
                    <div className="heroContainer">
                        <div className="heroTextContainer">
                            ...
                            <h2>Whether you're a trader, investor or just curious, we offer the tools to help you track your crypto holdings</h2>
                        </div>
                        <label>
                            <div className="getStartedContainer">
                                <a className="getStartedHeroImage" href="/register" >
                ...
                <div className="featureTitleCardContainer">
                    <h1>Why manage your crypto with DigiVault</h1>
                    <div className="featuresContainer">
                        <div className="featureCards" id="featureOne">
                            ...
                            <div className="featureDescription">
                                <h2>Track your portfolio performance</h2>
                                <p>Real-time balance tracking, historical performance, and more</p>
                            </div>
                        </div>
                        <div className="featureCards" id="featureTwo">
                            ...
                            <div className="featureDescription">
                                <h2>Stay informed with price alerts</h2>
                                <p>Set up price alerts for any asset and get notified when it hits your target</p>
                            </div>
                        </div>
                        <div className="featureCards" id="featureThree">
                            ...
                            <div className="featureDescription">
                                ...
                                <p>Download your portfolio data in seconds and use it however you like</p>
                            </div>
                        </div>
                        <div className="featureCards" id="featureFour">
                            ...
                            <div className="featureDescription">
                                <h2>Customize your watchlist</h2>
                                <p>Add and reorder assets in your watchlist and view in your preferred order</p>
                            </div>
                        </div>
                    </div>
                </div>
